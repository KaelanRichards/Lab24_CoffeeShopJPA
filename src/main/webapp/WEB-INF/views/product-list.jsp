...
<body>
	...
	<div class="container">
		...
		<table class="table">
             ...
             <tbody>
             	<c:forEach var="product" items="${products}">
             		<tr>
             			...
             			<td>${product.price}</td>
             			<td>
             				<a class="btn btn-light btn-sm" href="/product/${product.id}/update">Edit</a>
             				<a class="btn btn-light btn-sm" href="/product/${product.id}/delete">Delete</a>
		 ...
		 <a class="btn btn-secondary" href="/product/add">Add</a>
	</div>
</body>
</html>